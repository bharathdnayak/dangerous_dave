...
export const LEVELS: LevelData[] = [
    {
        ...
        hint: "Hop up the stepped platforms to reach the upper bridge and grab the TROPHY!",
        width: 44,
        height: 12,
        grid: [
    ...
    },
    {
        ...
        hint: "Hop up the steps to grab the GUN! Step across the stone pillars over water.",
        width: 52,
        height: 12,
        grid: [
            ...
            "B               R         R                  C   D B",
            "B @            BBB       BBB               BBBBBBBBB",
            "BBBBBBBWWWWWWWWBBBBWWWWWWWBBBBWWWWWWWWWWWWBBBBBBBBBB",
            "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB"
        ]
    },
    {
